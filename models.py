...
class User(UserMixin, db.Model):
    ...
    learning_languages = db.Column(db.String(200), nullable=False)  # JSON string
...
class Meeting(db.Model):
    ...
    duration = db.Column(db.Integer, default=60)  # в минутах
...
class MeetingParticipant(db.Model):
    ...
    rating = db.Column(db.Integer)  # Оценка встречи 1-5
